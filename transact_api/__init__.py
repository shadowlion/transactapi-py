...
class TransactApiClient:
    ...
    def get_trade_status(self, trade_id: str) -> GetTradeStatusResponse:
        """This method is used to retrieve the status and all other current information
        for a specific trade. The TradeID is required as a request parameter for this
        method.
